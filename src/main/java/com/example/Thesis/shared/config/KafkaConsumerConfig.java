...
/**
 * Kafka consumer configuration for the IoT sensor pipeline.
 *
 * <p>The Python simulator publishes messages without Spring type headers,
 * so {@link JsonDeserializer#USE_TYPE_INFO_HEADERS} is disabled and the
 * target type is set explicitly to {@link SensorDataDto}.</p>
 */
@Configuration
@EnableKafka
